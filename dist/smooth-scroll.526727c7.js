...
},{"process":"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"assets/smooth-scroll/smooth-scroll.js":[function(require,module,exports) {
var define;
...
!function (a) {
  ...
  var b = {},
      c = { exclude: [], excludeWithin: [], offset: 0, direction: "top", delegateSelector: null, scrollElement: null, scrollTarget: null, autoFocus: !1, beforeScroll: function beforeScroll() {}, afterScroll: function afterScroll() {}, easing: "swing", speed: 400, autoCoefficient: 2, preventDefault: !0 },
      d = function d(b) {
    var c = [],
        d = !1,
      ...
      e = /^([\-\+]=)(\d+)/;a.fn.extend({ scrollable: function scrollable(a) {
      var b = d.call(this, { dir: a });return this.pushStack(b);
    }, firstScrollable: function firstScrollable(a) {
      var b = d.call(this, { el: "first", dir: a });return this.pushStack(b);
    ...
    var b = { relative: "" },
      ...
      g = function g(b) {
    var c = a(b.scrollTarget);b.autoFocus && c.length && (c[0].focus(), c.is(document.activeElement) || (c.prop({ tabIndex: -1 }), c[0].focus())), b.afterScroll.call(b.link, b);
  };a.smoothScroll = function (c, d) {
    if ("options" === c && "object" == (typeof d === "undefined" ? "undefined" : _typeof(d))) return a.extend(b, d);var e,
        h,
        i,
        j,
        k = f(c),
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/smooth-scroll/smooth-scroll.js"], null)
//# sourceMappingURL=/smooth-scroll.526727c7.map